...
abstract class VisableFragment: Fragment() {
    private val onShowNotification = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
//            Toast.makeText(requireContext(),"Got a broadcast: ${intent.action}",
//                Toast.LENGTH_LONG)
//                .show()
            //Если мы получаем это, то мы видимы,поэтому отмените оповещения\
